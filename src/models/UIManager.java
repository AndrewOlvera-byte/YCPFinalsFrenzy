...
public class UIManager {
    ...
    public String getRoomCharactersOverlay(int playerId) {
     ...
     // 2. Render the Player separately on the far right
        if (player != null) {
            ...
            // Always use "Cooper" for player image regardless of player name
            ...
            // Base player image - always use Cooper.png
            sb.append("<div style='position: relative; display: inline-block;'>\n");
            sb.append("<img src='images/Cooper.png' alt='Player' style='width:2.5in; height:auto; background-color: transparent;'/>\n");
            ...
            for (ArmorSlot slot : ArmorSlot.values()) {
                ...
                // Get player-specific armor style for this slot - always use "Cooper" for styling
                ArmorStyle style = getArmorStyle("Cooper", slot);
    ...
    public Response display(int playerId) {
        Response response = new Response(
            ...
            getPlayerInventoryOverlay()  // Add the new inventory overlay
        );
        return response;
    }
}